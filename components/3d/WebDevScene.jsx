...
export default function WebDevScene({ isMobile }) {
    return (
        <div className="w-full h-full min-h-[220px] md:min-h-[320px] flex items-center justify-center relative overflow-hidden p-2 group">
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-blue-500/10 via-indigo-500/5 to-purple-500/10 rounded-2xl opacity-75 blur-xl group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
            ...
            >
                <Image
                    src="/web-platform.webp"
                    alt="Web Platforms Enterprise Illustration"
                    fill
