...
const QuickSummary = dynamic(() => import('./QuickSummary'), { ssr: false });
const DataFlowIllustration = dynamic(() => import('./Illustrations').then(mod => mod.DataFlowIllustration), { ssr: false });
const SecurityShieldIllustration = dynamic(() => import('./Illustrations').then(mod => mod.SecurityShieldIllustration), { ssr: false });
