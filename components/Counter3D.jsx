...
export default function Counter3D({ icon, value, suffix = "", label }) {
  ...
  return (
    <motion.div
      ...
      className="relative group rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 backdrop-blur-xl p-6 text-center cursor-pointer overflow-hidden shadow-sm dark:shadow-none"
